...
|---|---|---|---|---|---|---|
| Higo package | `package/hiveton/higoros/` | `$WORKSPACE_ROOT/work/h5000m-materials`, overlay ZIP, overlay-inspect | Vendor UI/backend plus compatibility defaults | CONFIRMED matching hashes | repository | editable only by scoped task |
...
| Factory backups | `$WORKSPACE_ROOT/outputs/h5000m-backup/` | device extraction | recovery evidence | ORIGINAL | IRREPLACEABLE | never modify/delete |
