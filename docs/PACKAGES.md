...
| luci | IMMORTALWRT_FEED | exact version UNKNOWN | luci `0b3572a17c1543257642716a4e1bdc9b0e74b8d4` | rescue/full; admin UI | PROJECT_LOCAL port-8080 coexistence configuration | Run 20 resolved selection and build PASS | Current device/UI UNVERIFIED | Feed-lock change only through candidate with build and device regression |
