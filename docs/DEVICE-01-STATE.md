...
CPE_REPAIR: `IMPLEMENTED_BUILD_UNVERIFIED`
...
RUN21_TRIGGERED: `YES`
RUN21_RESULT: `UNKNOWN`
RUN21_LAST_CONFIRMED_GATE: `CHECKOUT_PASS_DEPENDENCY_INSTALL_RUNNING`
RUN21_WAIT_REASON: `HEALTHY_EXTERNAL_BUILD`
RUN21_NEXT_ACTION: `OWNER_REPORTS_STATE_CHANGE_THEN_CONTEXT_RELOAD_AND_QUERY_ONCE`
